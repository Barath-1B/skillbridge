...
export default function RetakeMbtiTest() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const data = await retakeTestsService.getMbtiQuestions();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await retakeTestsService.retakeMbtiTest(answerArray);
      setMessage('MBTI test completed! Your profile has been updated.');
